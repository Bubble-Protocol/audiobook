...
| [`AudiobookRegistry.sol`](contracts/AudiobookRegistry.sol) | Singleton contract that acts a discovery service.  Any `AudiobookSDAC` registered with this contract will be discoverable with the [`user.sh discovery`](#audiobook-discovery) command. |
